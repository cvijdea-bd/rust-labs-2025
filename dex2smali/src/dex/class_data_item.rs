...
impl ClassDataItem {
    ...
    pub fn parse_from_bytes_with_offset(
        ...
        *offset += bytes_used;
        ...
        let static_fields = Self::read_encoded_fields(buffer, offset, static_fields_size as usize)?;

        let instance_fields =
            Self::read_encoded_fields(buffer, offset, instance_fields_size as usize)?;

        let direct_methods =
            Self::read_encoded_methods(buffer, offset, direct_methods_size as usize)?;

        let virtual_methods =
            Self::read_encoded_methods(buffer, offset, virtual_methods_size as usize)?;
